...
public class Cadastro {
	public void cadastrarGradeHoraria(Scanner scanner, GradeHoraria gradeHoraria) {
		int opcao;
		int defCodigo = 0;

		do {
			System.out.println("");
			System.out.println("Digite 1 para cadastrar uma grade horÃ¡ria ou 0 para voltar.");
			opcao = scanner.nextInt();
			scanner.nextLine();

			switch (opcao) {
			case 1:
				System.out.println("CADASTRO DE GRADE HORÃ�RIA.");
				do {
					System.out.print("Digite o codigo da grade: ");
					gradeHoraria.setCodigo(scanner.nextInt());
					scanner.nextLine();
					if (gradeHoraria.getCodigo() < 0) {
						System.out.println("O cÃ³digo nÃ£o pode ser menor que 0. Por favor digite novamente.");
						System.out.println("");
					} else {
						defCodigo = 1;
					}
